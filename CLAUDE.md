...
| [docs/FRONTEND_API.md](./docs/FRONTEND_API.md) | Frontend engineers | **Flat API reference** — auth, conventions, every endpoint's request/response shape. No architecture. Start here for "what do I call and what comes back" |
| [docs/PHASE_1_FRONTEND_GUIDE.md](./docs/PHASE_1_FRONTEND_GUIDE.md), [PHASE_2](./docs/PHASE_2_FRONTEND_GUIDE.md) & [PHASE_3](./docs/PHASE_3_FRONTEND_GUIDE.md) | Frontend engineers | Per-phase context + UX recommendations behind the API |
